...
Este é um tutorial de início rápido em uma única parte para criar uma aplicação de tarefa simples com o ABP Framework. Aqui está uma captura de tela da aplicação web final:

![todo-list](todo-list.png)

Você pode encontrar o código fonte da aplicação completa [aqui](https://github.com/abpframework/abp-samples/tree/master/TodoApp).

Esta documentação tem um tutorial em vídeo no **YouTube**!! Você pode assistir aqui:
...
* Uma IDE (ex. [Visual Studio](https://visualstudio.microsoft.com/vs/)) que oferece suporte ao desenvolvimento [.NET 7.0+](https://dotnet.microsoft.com/download/dotnet).
...
## Instale a ferramenta ABP CLI

Usaremos o [ABP CLI](../../CLI.md) para criar novas soluções ABP. Você pode executar o seguinte comando em uma janela de terminal para instalar o dotnet tool:
